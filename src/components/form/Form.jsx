...
export default function Form() {
  ...
  const generateCommand = () => {
    let command = `npx create-kuproy@latest ${projectName}`;
                  ...
                  <div id="db" className="">
                    ...
                    <div className="flex mt-2">
                      <div className="mr-5">
                        ...
                        />
                        <label className="ml-1 font-mulish font-normal text-base" htmlFor="MongoDB">MongoDB (Mongoose)</label>
                      </div>
                      ...
                      <div className="mr-5">
                        <input
                          ...
                          onChange={(e) => setDatabase(e.target.value)}
                        />
                        <label className="ml-1 font-mulish font-normal text-base" htmlFor="PostgreSQL">PostgreSQL (Prisma)</label>
                      </div>
                      ...
                      <div className="mr-5">
                        <input
                          ...
                          onChange={(e) => setDatabase(e.target.value)}
                        />
                        <label className="ml-1 font-mulish font-normal text-base" htmlFor="MySQL">MySQL (Prisma)</label>
                      </div>
                    </div>
                  </div>
                </div>
